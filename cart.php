...
<?php if ($items): ?>
    <form action="cart-action.php" method="post">
        ...
        <div class="d-flex flex-wrap justify-content-between gap-3 align-items-center"><button class="btn btn-outline-dark" type="submit">Update Cart</button><div class="text-end"><h4>Total: <span class="text-warning">Rs. <?= number_format($total, 2); ?></span></h4><a class="btn btn-warning" href="quote.php">Place Order</a></div></div>
    </form>
<?php else: ?>
