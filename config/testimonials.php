...
$testimonials = [
    ...
    [
        ...
        "message" => "Excellent customer service and premium quality materials.",
        "image" => "assets/images/testimonials/client2.jpg"
    ],
    [
        "name" => "Hari KC",
        "role" => "Home Owner",
        "message" => "Great collection of hardware products with reasonable prices and friendly staff.",
